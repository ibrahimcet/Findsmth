<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="internetProgramlama.search" %>
                ...
                <div class="paylasimlar-genel-div">
                    ...
                    <a href="<%
                        ...
                        <div class="paylasimlar-div">
                            ...
                            <div class="p-foto">
                                <div class="foto">
                                    <img src="<% Response.Write(image_displayer()); %>">
                                </div>
                                <div class="aciklama">
                                    <div class="aciklama-div">
                                        <p class="paragraf"><%#Eval("urunAciklama") %></p>
                                    </div>
                                </div>
                            </div>
